            ...
            if ($objects)
            {
                ...
                switch ($format)
                {
                    ...
                    case 'rtf':
                        ...
                        // $tr = new TTableWriterRTFSis($widths, 'L');
...
/*
                    ...
                    $title_form_current = $reflectionProperty->getValue($this->form);
 */
                    ...
                    if ($format == 'pdf')
                    {
                        ...
                        $tr->setHeaderCallback(
                            function($tr)
                            {
                                ...
                                // Texto do cabeçalho
                                // $pdf->Cell(30,10, utf8_decode('Cabeçalho do relatório') ,0,0,'C');
                                // $pdf->Cell(30,10, utf8_decode( $report_title ) ,0,0,'C');
                                // $pdf->Cell(30,10, utf8_decode( $tr->arg1 ) ,0,0,'C');
                                // $pdf->Cell(0,10, utf8_decode( $tr->arg1 ) ,0,0,'C');
                        ...
                        $tr->setFooterCallback(
                            function($tr)
                            {
                                ...
                                // Footer
                                // $pdf->Cell(0,10, utf8_decode("Footer: Página: {$numero}/{nb}") ,0,0,'R');
